    ...
    async def send_periodically():
        while True:
            ...
            if "ServiceCube" in usb_manager.boards:
                await teensy_controller.send_move_device_command("ServiceCube", "Lift_A", 100, 100, 100)
            if "RoboCubeBack" in usb_manager.boards:
                await teensy_controller.send_move_device_command("RoboCubeBack", "Rodell_C", 10, 100, 100)
