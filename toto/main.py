...
video_asp_ratio  = video_resolution[0] / video_resolution[1]  # Aspect ratio of each frame
video_viewangle_hor = math.radians(25)  # Camera FOV (field of view) angle in radians in the horizontal direction
...
try:
    print("starting loop")
    while True:
        # Read the frame from the stream URL
