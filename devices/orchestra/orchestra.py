...
def generate_drink_recipe(product_name, choosen_size, choosen_sugar, choosen_mug, choosen_lid, which_terminal, RoboCube, receipt_number, amount_in_cents, is_last_product=False):
    ...
    recipe.append("RoboCubeFront:  moveDevice('Snackbar', '300', '100', '100', '10')")
    recipe.append("RoboCubeFront:  moveDevice('Terminal', '100', '100', '100', '100')")
    recipe.append("RoboCubeFront:  moveDevice('Snackbar', '0', '100', '100', '10')")
    recipe.append("RoboCubeFront:  moveDevice('Schleuse', '0', '100', '100', '10')")
    recipe.append("RoboCubeFront:  moveDevice('Terminal', '0', '100', '100', '10')")
    ...
    recipe.append("RoboCubeBack:  moveDevice('Terminal', '0', '100', '100', '10')")
