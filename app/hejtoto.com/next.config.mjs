...
const nextConfig = {
  ...
  */
  ...
  env: {
    ...
    NEXT_PUBLIC_WEBSOCKET_SERVER_ENV: process.env.NEXT_PUBLIC_WEBSOCKET_SERVER_ENV,
    NEXT_PUBLIC_WEBSOCKET_SERVICE_ENV: process.env.NEXT_PUBLIC_WEBSOCKET_SERVICE_ENV,
  },
};
