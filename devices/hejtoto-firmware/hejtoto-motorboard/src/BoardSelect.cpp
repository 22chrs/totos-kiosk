...
const BoardConfig ServiceCubeConfig = {
    "ServiceCube",
    {
        ...
        {100, 2000, 2000, 2 / (RESOLUTION / MICROSTEPS), 555, 5, false},           // Stepper 1 //! geraten! Lift_1
        {100, 5000, 5000, (20 / 80) / (RESOLUTION / MICROSTEPS), 333, 5, false},   // Stepper 2 //! geraten! Karusell_1
        {100, 10000, 5000, 2 / (RESOLUTION / MICROSTEPS), 555, 5, false},          // Stepper 3 //! geraten! Lift_2
        {100, 10000, 5000, (20 / 80) / (RESOLUTION / MICROSTEPS), 333, 5, false},  // Stepper 4 //! geraten! Karusell_2
        {100, 10000, 5000, 2 / (RESOLUTION / MICROSTEPS), 555, 5, false},          // Stepper 5 //! geraten! Lift_3
        {100, 10000, 5000, (20 / 80) / (RESOLUTION / MICROSTEPS), 333, 5, false},  // Stepper 6 //! geraten! Karusell_3
    }};
