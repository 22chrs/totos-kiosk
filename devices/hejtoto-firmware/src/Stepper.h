...
inline StepperMotor stepperMotors[6] = {
    {&USED_SERIAL_PORT_1, EN1_PIN, DIR1_PIN, STP1_PIN, DIR1_PIN_DUMMY, new TMC2208Stepper(&USED_SERIAL_PORT_1, R_SENSE), new Stepper(STP1_PIN, DIR1_PIN_DUMMY)},
    {&USED_SERIAL_PORT_2, EN2_PIN, DIR2_PIN, STP2_PIN, DIR2_PIN_DUMMY, new TMC2208Stepper(&USED_SERIAL_PORT_2, R_SENSE), new Stepper(STP2_PIN, DIR2_PIN_DUMMY)},
    {&USED_SERIAL_PORT_3, EN3_PIN, DIR3_PIN, STP3_PIN, DIR3_PIN_DUMMY, new TMC2208Stepper(&USED_SERIAL_PORT_3, R_SENSE), new Stepper(STP3_PIN, DIR3_PIN_DUMMY)},
    {&USED_SERIAL_PORT_4, EN4_PIN, DIR4_PIN, STP4_PIN, DIR4_PIN_DUMMY, new TMC2208Stepper(&USED_SERIAL_PORT_4, R_SENSE), new Stepper(STP4_PIN, DIR4_PIN_DUMMY)},
    {&USED_SERIAL_PORT_5, EN5_PIN, DIR5_PIN, STP5_PIN, DIR5_PIN_DUMMY, new TMC2208Stepper(&USED_SERIAL_PORT_5, R_SENSE), new Stepper(STP5_PIN, DIR5_PIN_DUMMY)},
    {&USED_SERIAL_PORT_6, EN6_PIN, DIR6_PIN, STP6_PIN, DIR6_PIN_DUMMY, new TMC2208Stepper(&USED_SERIAL_PORT_6, R_SENSE), new Stepper(STP6_PIN, DIR6_PIN_DUMMY)}};
